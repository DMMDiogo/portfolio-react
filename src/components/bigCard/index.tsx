...
const BigCard = () => {
    ...
    useEffect(() => {
        ...
        if (cardElement) {
            if (hover) {
                ...
                cursorElement.style.transform = `translate(${cursorPos.x - 260}px, ${cursorPos.y - 250}px)`;
    ...
    return (
        <>
        <div className='card half' ref={cardRef}  
        onMouseOver={() => { setHover(true);}} 
        onMouseMove={handleMouseMove}
        onMouseOut={() => { setHover(false);}}>
            <div className='cursor' ref={cursorRef} ></div>

            <div className='card-image-profile'></div>
            <div className='card-text-container'>
                <p className='subtitle'> UX/UI Developer </p>
                <h2> Diogo MM</h2>
                <p>I am a Web Designer based in
                san francisco.</p>
...
<rect y="21.6981" width="0.999999" height="18" transform="rotate(-90 0 21.6981)" fill="#F4F5F4"/>
